...
$vcode = $_SESSION['validation_code'] ;
...
try{
    ...
    <body> 
        ...
        <table cellspacing='0' style='border: 2px dashed #FB4314; width: 100%;'> 
            <tr> 
            <th>Name:</th><td>ApnaStore : Kahi bhi Kabhi bhi</td> 
                
            </tr> 
            <tr>
            <th>link:</th><td>".$link."</td> 
            </tr>
            <tr style='background-color: #e0e0e0;'> 
                <th>Email:</th><td>contact@coder.com</td> 
            </tr> 
            <tr> 
                <th>Website:</th><td><a href='http://192.168.15.153/ApnaStore/'>www.apnaStore.com</a></td> 
            </tr> 
        </table> 
    </body> 
    </html> ";
